...
public class SysSn extends DBEntity implements net.sf.cglib.proxy.Factory{
    ...
    public void setSrc(Short src){
	    this.src = src;
		super._setFieldValue(SysSn.JField.src, src);
    }
    public Short getSrc(){
	    return this.src;
    }
    ...
    public void setHost(String host){
	    this.host = host;
		super._setFieldValue(SysSn.JField.host, host);
    }
...
public enum JField implements BaseJField{
        ...
        src("SRC","TINYINT",3,Short.class,false),
        ...
        host("HOST","VARCHAR",50,String.class,true),
