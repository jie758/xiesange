...
public class WxTempMessageParam {
	private Map<String,Map<String,String>> data = ClassUtil.newMap();
	
	/*private String key;
	private String value;
	private String color;*/
	public WxTempMessageParam(){}
	public WxTempMessageParam(String key,String value){
		this(key,value,null);
	}
	public WxTempMessageParam(String key,String value,String color){
	...
	public WxTempMessageParam addParam(String key,String value){
		return addParam(key,value,null);
	}
	
	public WxTempMessageParam addParam(String key,String value,String color){
		Map<String,String> val = ClassUtil.newMap();
		val.put("value", value);
		val.put("color", color);
		data.put(key, val);
