...
public class SysSequence extends DBEntity implements net.sf.cglib.proxy.Factory{
    ...
    public void setId(Long id){
	    this.id = id;
		super._setFieldValue(SysSequence.JField.id, id);
    }
    public Long getId(){
	    return this.id;
    }
    ...
    public void setTableKey(String tableKey){
		...
		super._setFieldValue(SysSequence.JField.tableKey, tableKey);
    }
    ...
    public void setValue(Long value){
	    this.value = value;
		super._setFieldValue(SysSequence.JField.value, value);
    }
    ...
    public void setUpdateTime(java.util.Date updateTime){
		...
		super._setFieldValue(SysSequence.JField.updateTime, updateTime);
    }
    ...
    public void setCreateTime(java.util.Date createTime){
		...
		super._setFieldValue(SysSequence.JField.createTime, createTime);
    }
...
public enum JField implements BaseJField{
        ...
        {
            return com.xiesange.gen.dbentity.sys.SysSequence.class;
        }
    }
