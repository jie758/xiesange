...
public abstract class AbstractController{
     ...
     * @throws Exception
     */
	public SysSn insertSysSn(IException ex,RequestContext context) throws Exception{
	...
	protected ModelAndView parseErrorOutput(IException ex,RequestContext context) throws Exception{
